...
▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔
     ...
     199.5┤                                                                           ╭───╯   ╰─╮     │
     159.6┤                                                                 ╭─╮ ╭─╮   │         ╰─╮   │
     119.7┤ long-term mean                                            ╭─╮ ╭─╯ │ │ │ ╭─╯           │ ╭─╯
      79.8┤<code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code>│<code style="color : #8dc990">┄</code>╰─╯<code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code>╰─╯<code style="color : #8dc990">┄</code>╰─╯<code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code>╰─╯<code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code><code style="color : #8dc990">┄</code>
      39.9┤                                                           │
       0.0┼───────────────────────────────────────────────────────────╯
...
╠══════════════════════════╬═════════════════╬═══════════════╬═════════════════╬═══════════════════╬═══════════╣
║ <a href="https://github.com/chasenunez/chasenunez">chasenunez</a>               ║      Python     ║     27435     ║       678       ║     2026-01-09    ║     2     ║
╠══════════════════════════╬═════════════════╬═══════════════╬═════════════════╬═══════════════════╬═══════════╣
...
╚══════════════════════════╩═════════════════╩═══════════════╩═════════════════╩═══════════════════╩═══════════╝
                               ...
                               ⢀⣠⣴⣾<code style="color : #8dc990">⣿</code> Updated Saturday Morning At 02:04 CEST <code style="color : #8dc990">⣿</code>⣷⣦⣄<code style="color : #8dc990">⡀</code>                               
</pre>
